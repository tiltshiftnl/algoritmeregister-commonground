# proto-component-commonground chart

The Helm chart installs proto-component-commonground and by default the following dependencies using subcharts:
...
```bash
helm repo add proto-component-commonground https://raw.githubusercontent.com/ConductionNL/Proto-component-commonground/master/api/helm/
helm repo update
```
...
```bash
helm install my-proto-component-commonground ConductionNL/Proto-component-commonground --version 0.1.0
```
...
| `settings.subdomain` | the subdomain of the installation excluding www. | `proto-component-commonground` |
| `settings.subpath` | Any sub path to follow the domain, like /api/v1 | `proto-component-commonground` |
